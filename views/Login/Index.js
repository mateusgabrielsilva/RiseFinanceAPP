...
export default function Login({navigation}) {
  ...
  return(
    ...
    >
      ...
      <Text h3 style={loginStyles.titleText}>Sign In</Text> 
      <Text>{message}</Text>
      ...
      <View style={loginStyles.containerApp}>
        ...
        <Input
          ...
          rightIcon={{type: 'font-awesome', name: passwordView, color:'#BCBCAF', size: 18, onPress:() => viewPassword()}}
        ...
        <Text
          style={loginStyles.buttonSignUp}
          onPress={()=> signUp()}
        >
          Registre-se aqui 
        </Text>
